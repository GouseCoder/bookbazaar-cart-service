package com.bookbazaar.hub.cartservice.config;
...
import com.bookbazaar.hub.cartservice.utils.SwaggerConstants;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.bookbazaar.hub.cartservice.controller"))
